...
import { Counter, OwnershipTransferred, NameRenewed, NameRegistered } from "../generated/schema"
...
export function handleNameRegistered(event: NameRegisteredEvent): void {
    ...
    nameRegistered.baseCost = event.params.baseCost
    nameRegistered.premium = event.params.premium
